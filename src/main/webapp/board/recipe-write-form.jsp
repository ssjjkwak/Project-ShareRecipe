	...
	<body style="background-color: #F9FAFD">
		<div class="container">
          ...
          <div class="col-lg-7 mx-auto text-center mt-7 mb-5">
			...
			<input class="form-control border-5 input-box bg-100" type="text" name="title" placeholder="제목을 입력해 주세요." style="font-family: 'Jua'; font-weight: 500;" aria-label="Search" required="required"/><br>
