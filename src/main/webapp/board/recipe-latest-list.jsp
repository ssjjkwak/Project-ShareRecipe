          ...
          <c:forEach items="${requestScope.latestList }" var="li">
            ...
            <a href="RecipeDetailController.do?recipeNo=${li.recipeNo }" style="display:block;">
              <div class="card card-span h-100 text-white rounded-3 "><img class="img-fluid rounded-3 h-100" style="width: 300px;  height: 150px; object-fit: cover;" src="./image/${li.image }" alt="..."  />
                <div class="card-img-overlay ps-0"><span class="badge bg-danger p-2 ms-3"><i class="fas fa-tag me-2 fs-0"></i><span class="fs-0" style="font-family: 'Jua'; font-weight: 500;">${li.categoryVO.cName }</span></span><span class="badge bg-primary ms-2 me-1 p-2"><i class="fas fa-clock me-1 fs-0"></i><span class="fs-0" style="font-family: 'Jua'; font-weight: 500;">Fast</span></span></div>
                <div class="card-body ps-0">
                    <div class="flex-1 ms-3" style="width:239px;">
                      <h5 class="mb-0 fw-bold text-1000 etc" style="font-family: 'Jua';">${li.title}</h5><span class="text-primary fs--1 me-1"><i class="fas fa-star"></i></span><span class="mb-0 text-primary" style="font-family: 'Jua'; font-weight: 500;">${li.hits}</span>
                    </div>
                </div>
              </div>
              </a>
