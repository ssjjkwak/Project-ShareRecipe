  ...
  <c:import url="../header.jsp"></c:import>
	 <br><br><br><br><br><br>
      <div class="container">
		...
		<h4 style="text-align: 'center'; font-family: 'Jua'; font-weight: 100; " >최신등록순</h4>
		<div class="d-grid gap-12"><a style="font-family: 'Jua'; font-weight: 100; font-size: 20px; text-align: right;" href="board/recipe-form.jsp" >레시피 작성</a></div>
