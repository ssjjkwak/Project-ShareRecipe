	 ...
	 <br><br><br><br><br><br>
      <div class="container">
		...
		<c:if test="${pagingBean.previousPageGroup }"> <!-- el동작이 get이랑 is계열 메서드의 return을 받아오는데 is계열은 t/f반환이므로 -->
		 <li class="page-item"><a class="page-link" href="RecipeListController.do?pageNo=${pagingBean.startPageOfPageGroup-1 }">Previous</a></li> 
		 ...
		 <!--   <li class="page-item"><a class="page-link" href="#">1</a></li>
		  ...
		  <li class="page-item"><a class="page-link" href="RecipeListController.do?pageNo=${pagingBean.endPageOfPageGroup+1 }">Next</a></li>
		  </c:if>
		</ul><br>
        </div>
      </main>
