			...
			<div class="col-lg-7 mx-auto text-center mt-7 mb-5">
				...
				<form action="RegisterMemberController.do">
					<input class="form-control border-0 input-box bg-100"
						...
						type="text" name="joinId" placeholder="아이디를 입력하세요."
						required="required">
					<button class="btn btn-danger" style="position:relative; margin:0;padding:0; height: 38px; width:20%;"
					...
					<br> 
					<input class="form-control border-0 input-box bg-100" style="font-family: 'Jua'; font-weight: 500;" type="text" name="joinName" placeholder="이름 입력"
						required="required"> 
					<br> 	
					<input class="form-control border-0 input-box bg-100"
					...
					<input class="form-control border-0 input-box bg-100" style="font-family: 'Jua'; font-weight: 500;"
						type="text" name="joinTel" placeholder="휴대폰번호(공백없이 숫자만 입력)"
						required="required"><br> 
					<input class="form-control border-0 input-box bg-100" style="font-family: 'Jua'; font-weight: 500;" type="date"
						name="joinBirthday" required="required"><br> 
					<input class="form-control border-0 input-box bg-100" style="font-family: 'Jua'; font-weight: 500; width: 48%;display: inline-block; float:left;margin-bottom:20px;"
						type="text" name="joinMail1" placeholder="이메일"
						required="required">
					<%-- <span style="position: relative; top:5px">@</span>--%> 
					<select class="form-control border-0 input-box bg-100" style="font-family: 'Jua'; font-weight: 500; width: 45%;display:block; float:right;margin-bottom:20px;" name="joinMail2"
						id="email_server" onchange="input_email();">
					...
					<br>
					<button class="btn btn-danger btn-lg" style="margin-top: 20px;">회원가입</button>
				</form>
			</div>
		</div>
	</div>
