...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" data-navbar-on-scroll="data-navbar-on-scroll">
  <div class="container"><a class="navbar-brand d-inline-flex" href="index.jsp"><img width="200px" height="90px" class="d-inline-block" src="assets/img/favicons/favicon.jpg" alt="logo" /></a>
	...
	<c:otherwise>
        <a href="member/update-member.jsp"><div class="btn btn-white text-warning" style="font-family: 'Jua'; font-weight: 500;"> <i class="fas fa-user me-2"></i>${sessionScope.mvo.name}님</div></a>
